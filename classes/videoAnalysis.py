...
from utils import compareWithSSIM
...
class VideoAnalysis:
    ...
    def matchFeatures(self, features, cutFrame1 = None, cutFrame2 = None):
        try:
    ...
    def getLight(self, staticFrame, movingFrame, homographyStaticToStatic, ptsMovingCam, homographyStaticToMoving, worldHomography, kMoving, dstStatic):
        
        matchesStaticStatic = None
        matchesStaticMoving = None
        ...
        if homographyStaticToStatic is not None and homographyStaticToMoving is not None:
            ...
            corr = compareWithSSIM(worldFrame, warpedMoving)
        ...
        if lightVector is not None and worldFrame is not None:
            matchesStaticStatic = len(dstStatic)
            matchesStaticMoving = len(ptsMovingCam)

        return worldFrame, lightVector, matchesStaticStatic, matchesStaticMoving